 ...
 *iOS Seven Theme*: Solid colors without gradients, crisp & clear text (default iOS 7+)<br/>
 *Light Theme*: Brighter colors based on a white background (default pre-iOS 7)<br/>
 *Dark Theme*: Softer colors on a black background
 ...
 There are two recommended ways to provide your own custom theme: <br/>
 You can use one of the provided SChartTheme classes and customise the style objects provided on it. <br/>
